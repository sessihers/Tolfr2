...
public class DijkstraSP {
    ...
    private double[] SecDistTo;       // distTo[v] = distance  of second shortest s->v path
    private DirectedEdge[] SecEdgeTo; // edgeTo[v] = last edge on second shortest s->v path
    private DirectedEdge[] SecFinalEdgeTo;
    ...
    public Iterable<DirectedEdge> SecPathTo(int v) {
        ...
        if (!hasPathTo(v)) return null;
        Stack<DirectedEdge> path = new Stack<DirectedEdge>();
        for (DirectedEdge e = SecFinalEdgeTo[v]; e != null; e = SecFinalEdgeTo[e.from()]) {
            path.push(e);
        }
        return path;
    }
    ...
    public static void main(String[] args) {
        ...
        for (int t = 0; t < G.V(); t++) {
            if (sp.hasPathTo(t)) {
              ...
              {
                StdOut.printf("%d to %d (%.2f)  ", s, t, sp.SecondDP(G, s, t));
